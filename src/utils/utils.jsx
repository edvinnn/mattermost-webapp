...
import bing from 'src/sounds/bing.mp3';
import crackle from 'src/sounds/crackle.mp3';
import down from 'src/sounds/down.mp3';
import hello from 'src/sounds/hello.mp3';
import ripple from 'src/sounds/ripple.mp3';
import upstairs from 'src/sounds/upstairs.mp3';
